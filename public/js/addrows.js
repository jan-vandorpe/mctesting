$(document).ready(function() {
    ...
    $(AddButton).click(function(e)  //on add input button click
    {
            ...
            //add input box
            $(InputsWrapper).append('<div class="input-group nieuwantwoord"><span class="input-group-addon widthvraaginput">Antwoord '+FieldCount+':</span><textarea name="antwoord[]" id="'+FieldCount+'" class="form-control allowcode" placeholder="vul hier een antwoord in." onload="initTinyMce()"></textarea>' +
                    '</div>');
            $(Select).append('<option value="'+FieldCountLow+'">Antwoord '+FieldCount+'</option>');
            x++; //text box increment
            
            jQuery(".allowcode").each(function(){ 
